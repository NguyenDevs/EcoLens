...
/** Modern color palette for EcoLens. Converted from res/values/colors.xml */

// Primary Colors
val Primary = Color(0xFF018367)
val PrimaryDark = Color(0xFF033826)
val PrimaryLight = Color(0xFF4CAF50)
val OnPrimary = Color(0xFFFFFFFF)

// Primary with opacity
val Primary10 = Color(0x1A018367)
val Primary20 = Color(0x33018367)
val Primary30 = Color(0x4D018367)
val Primary40 = Color(0x66018367)

// Surface Colors
val Surface = Color(0xFFFFFFFF)
val SurfaceVariant = Color(0xFFF8F9FA)
val SurfaceTint = Color(0xFFF0F7F4)
...
val BorderNormal = Color(0xFFE0E0E0)
val BorderStrong = Color(0xFFD0D0D0)

// Semantic Colors - Success
val Success = Color(0xFF00A86B)
val SuccessBg = Color(0xFFE8F5E9)
val SuccessText = Color(0xFF00796B)
...
// Confidence Levels
val ConfidenceHigh = Color(0xFF00A86B)
val ConfidenceHighBg = Color(0xFFE8F5E9)
val ConfidenceHighText = Color(0xFF00796B)

val ConfidenceMedium = Color(0xFFF57C00)
val ConfidenceMediumBg = Color(0xFFFFF3E0)
val ConfidenceMediumText = Color(0xFFE65100)

val ConfidenceLow = Color(0xFFD32F2F)
val ConfidenceLowBg = Color(0xFFFFEBEE)
val ConfidenceLowText = Color(0xFFC62828)

// Interactive States
val StateHover = Color(0xFFF5F5F5)
val StatePressed = Color(0xFFEEEEEE)
val StateFocus = Color(0xFFE3F2FD)
val StateDisabled = Color(0xFFF5F5F5)
...
// Navigation
val NavSelected = Color(0xFF033826)
val NavUnselected = Color(0xFFCCD7D1)
val NavBackground = Color(0xFFFFFFFF)

// Shadows
val ShadowLight = Color(0x14000000)
val ShadowNormal = Color(0x1F000000)
val ShadowStrong = Color(0x29000000)
...
val BorderNormalDark = Color(0xFF404040)
